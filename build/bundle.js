...
app.get('*', function (req, res) {
    ...
    var promises = (0, _reactRouterConfig.matchRoutes)(_Routes2.default, req.path).map(function (_ref) {
        ...
        // this logic is wrapping each promise with a promise so we can ALWAYS resolve it.  Otherwise Promise.All stops after 1 promise hits an issue
        if (promise) {
...
// serialize converts the chars in js script tags to unicode to avoid executing malicious javascript
